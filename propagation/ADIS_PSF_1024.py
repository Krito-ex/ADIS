...
parser.add_argument("--fill_ratio", type=float, default=0.5, help='mask duty ratio')
...
def calculate_point_depth_psf(point_depth, args):
    ...
    psfs = np.zeros((nC, 520*2, 520*2), dtype=np.float32)
    ...
    for i in range(len(wavelengths)-1):
        ...
        u3 = Scalar_mask_XY(x, y, wavelength=wavelength)
        ...
        psfs[i] = psf
    return psfs[:,8:1032,8:1032]     # 1024
...
if __name__ == '__main__':
    ...
    save_path = save_root + f'{opt.mask_period}um-1024.npy'
