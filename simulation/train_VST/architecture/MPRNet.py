...
class SAM(nn.Module):
    def __init__(self, n_feat, kernel_size, bias):
        ...
        self.conv2 = conv(n_feat, 28, kernel_size, bias=bias)
        self.conv3 = conv(28, n_feat, kernel_size, bias=bias)
...
class MPRNet(nn.Module):
    def __init__(self, in_c=28, out_c=28, n_feat=28, scale_unetfeats=28, scale_orsnetfeats=28, num_cab=4, kernel_size=3, reduction=1, bias=False):
        super(MPRNet, self).__init__()

        self.conv_in = nn.Conv2d(in_c, in_c, kernel_size=kernel_size, padding=(kernel_size - 1) // 2,
                                 bias=bias)
